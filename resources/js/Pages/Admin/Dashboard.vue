                ...
                >
                    <div class="flex items-start justify-between mb-3">
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center" :class="stat.bg">
                            <svg class="w-4 h-4" :class="stat.iconColor" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    ...
                    <form @submit.prevent="submit" class="px-6 py-5 space-y-4">
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Invite Link</label>
                            <div class="flex gap-3">
                                ...
                                <button
                                    ...
                                    class="px-5 py-2.5 text-sm font-semibold text-white rounded-xl transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                        ...
                        <div v-if="whatsappLink" class="flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg border border-gray-100">
                            ...
                            <a :href="whatsappLink" target="_blank" class="text-xs text-emerald-600 hover:underline ml-auto shrink-0">Test ↗</a>
                        </div>
                        ...
                        <div class="p-3 space-y-1">
                            ...
                            >
                                <div class="w-8 h-8 rounded-lg bg-slate-100 group-hover:bg-slate-200 flex items-center justify-center transition shrink-0">
                                    <svg class="w-3.5 h-3.5 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                ...
                                <svg class="w-3.5 h-3.5 text-gray-300 group-hover:text-gray-400 transition shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
